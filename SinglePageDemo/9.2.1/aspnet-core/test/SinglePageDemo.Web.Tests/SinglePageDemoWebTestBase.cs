...
{
    public abstract class SinglePageDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SinglePageDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SinglePageDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SinglePageDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SinglePageDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SinglePageDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SinglePageDemoDbContext, Task<T>> func)
        {
            T result;
